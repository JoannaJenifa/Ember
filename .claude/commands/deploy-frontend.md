...
Deploy the Next.js live commerce app to Vercel.
...
- [ ] Core features work (products, streaming, purchase)
- [ ] Wallet connection works
...
```
/deploy-frontend preview for testing new live stream UI
```
...
### Error: "Wallet connection fails on deployed site"
**Fix:** Check CORS settings, verify RPC URL env var
