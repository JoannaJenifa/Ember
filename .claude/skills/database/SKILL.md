...
## IMPORTANT: All tables/views/functions MUST be prefixed with `ember_`

## Active tables (off-chain data):
- No tables created yet. Create tables as needed with `ember_` prefix.

## Auth: Using SERVICE ROLE KEY (no RLS)
- RLS is DISABLED on all ember_ tables
